...
vim.keymap.set(
  "n",
  "<leader>oo",
  ":cd /Users/amrom/Documents/Obsidian/AmroMassalha/<cr>",
  { desc = "Obsidian navigate to vault" }
)
--
...
vim.keymap.set(
  ...
  { desc = "Obsidian convert note to template and remove leading white space" }
)
...
vim.keymap.set(
  ...
  "<leader>of",
  ":s/\\(# \\)[^_]*_/\\1/ | s/-/ /g<cr>",
  { desc = "Obsidian strip date from note title and replace dashes with spaces" }
)
--
...
vim.keymap.set(
  "n",
  "<leader>os",
  ':Telescope find_files search_dirs={"/Users/amrom/Documents/Obsidian/AmroMassalha"}<cr>',
  { desc = "Obsidian search for files in full vault" }
)
vim.keymap.set(
  "n",
  "<leader>oz",
  ':Telescope live_grep search_dirs={"/Users/amrom/Documents/Obsidian/AmroMassalha/notes"}<cr>',
  { desc = "Obsidian search for files in vault under notes" }
)
--
...
vim.keymap.set(
  "n",
  "<leader>ok",
  ":!mv '%:p' /Users/amrom/Documents/Obsidian/AmroMassalha/keep/<cr>:bd<cr>",
  { desc = "Obsidian move file in current buffer to keep folder" }
)
-- delete file in current buffer
vim.keymap.set("n", "<leader>odd", ":!rm '%:p'<cr>:bd<cr>", { desc = "Obsidian delete file in current buffer" })
