...
keymap.set("n", "tk", ":blast<enter>", { noremap = false })
keymap.set("n", "tj", ":bfirst<enter>", { noremap = false })
keymap.set("n", "th", ":bprev<enter>", { noremap = false })
keymap.set("n", "tl", ":bnext<enter>", { noremap = false })
